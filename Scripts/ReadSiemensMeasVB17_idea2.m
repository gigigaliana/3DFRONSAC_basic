function [data,loopcounters,sMDH,lc_names] = ReadSiemensMeasVB17(measfile, dispopt)
...
hdr_len = fread(fid, 1, 'uint32=>uint8'); %%..maolin modified according to Florian.Knoll at IDEA Board 4/30/2009
